/***********************************************************
 * $Id: PKCS11Provider.java 33 2007-01-26 19:37:44Z wolfgang.glas $
 * 
...
public class PKCS11Provider extends Provider implements DestroyableParent
{
	 ...
	 */
	private static final long serialVersionUID = -5559292781914182039L;
	...
	private static String libraryName = "opensc-PKCS11-" + version;
	private static String libraryPath = "";
	
	static {

		// Loads and links the dynamic library that is identified through the 
		// specified path; it removes the older approach via loadLibrary
